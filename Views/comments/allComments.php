...
<?php /** @var \Mobius\ViewModels\CommentViewModel[] $model*/?>
...
<div class="container">
    <div class="tab-content">
        <div class="tab-pane active" id="daftar">
            <br/>
            <p><a class="btn btn-success"href="http://localhost:8004/MobiusTask/users/profile">Back To Profile</a>
                <a class="btn btn-primary" href="http://localhost:8004/MobiusTask/comments/addcomment"><span class="glyphicon glyphicon-plus"></span>Add Comment</a></p>
            <br/>
